"""
子域名查询工具
url:https://www.baidu.com/s?wd=site:toutiao.com&pn=0
"""
...
# # 爬取数据
# domain = 'baidu.com'
# url = "https://cn.bing.com/search?q=site:%s&first=0"%domain
# header = {
...
# 正则表达式  class="b_attribution"><cite>(.*?)<
# class="b_attribution"><cite>https://so.<strong>toutiao.com</strong></cite>
# class="b_attribution"><cite>(.*?)<
...
# 爬取数据
parse = OptionParser("%prog -d domain -p page \n Example: %prog -d baidu.com -p 5")
# 添加选项
